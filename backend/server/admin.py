...
from .models.ecommerce_model import (
    Category, Order, OrderItem, Cart, CartItem,
    Review, Wishlist
)
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'brand', 'price', 'sale_price', 'stock', 'is_active', 'is_featured')
...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ('username', 'email', 'phone_number', 'is_active', 'is_email_verified', 'created_at')
    list_filter = ('is_active', 'is_email_verified', 'newsletter_subscription', 'created_at')
