<template>
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12 relative overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <button @click="toggleOrderDetails(order.id)" class="btn btn-sm btn-ghost">
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <button @click="trackOrder(order)" class="btn btn-sm btn-outline">
                                Track Order
                            </button>
                        </div>
                        ...
                        <div v-if="expandedOrderId === order.id" class="mt-6 border-t pt-4">
                            ...
                            <div class="flex justify-between mt-4">
                                ...
                                <button @click="downloadInvoice(order)" class="btn btn-sm btn-outline">
        ...
        <!-- Track Order Modal -->
        <div v-if="showTrackingModal && selectedOrder"
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg p-6 mx-4">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button @click="showTrackingModal = false" class="btn btn-sm btn-circle btn-ghost">✕</button>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-between">
                            <div v-for="(step, index) in trackingSteps" :key="index" class="flex flex-col items-center">
                                <div class="rounded-full w-8 h-8 flex items-center justify-center z-10 mb-2"
                                    :class="getTrackingStepClass(step.status, selectedOrder.status)">
                                    <svg v-if="isStepComplete(step.status, selectedOrder.status)"
                ...
                <div class="text-center mt-8">
                    <button @click="showTrackingModal = false" class="btn btn-primary">Close</button>
                </div>
            </div>
        </div>
        ...
        <div v-if="showCancelModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 mx-4">
                ...
                <div class="flex justify-center space-x-4">
                    ...
                    <button @click="confirmCancelOrder" class="btn btn-error" :disabled="isCancelling">
