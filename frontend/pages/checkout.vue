    ...
    <div class="container max-w-6xl mx-auto px-4 py-8">
      ...
      <div v-if="currentStep !== 'confirmation'" class="mb-8">
        <div class="flex items-center justify-between max-w-2xl mx-auto">
          ...
          <div class="flex-1 h-1 mx-4" :class="currentStep === 'cart' ? 'bg-gray-200' : 'bg-orange-500'"></div>
          ...
          <div class="flex-1 h-1 mx-4" :class="currentStep === 'payment' ? 'bg-orange-500' : 'bg-gray-200'"></div>
            ...
            <div v-if="cartItems.length > 0" class="divide-y divide-gray-100">
              ...
              >
                ...
                <div class="flex-grow">
                  ...
                  <p class="font-semibold text-gray-900 mt-1">${{ (item.price / 100).toFixed(2) }}</p>
                </div>
                
                <!-- Quantity control -->
                <div class="flex items-center border rounded-md mr-6">
                  <button 
                ...
                <div class="text-right">
                  <p class="font-semibold text-orange-500">${{ ((item.price * item.quantity) / 100).toFixed(2) }}</p>
                  <button 
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3 mb-4">
              <div class="flex justify-between text-gray-700">
                ...
                <span>${{ (getItemsPrice / 100).toFixed(2) }}</span>
              </div>
              <div class="flex justify-between text-gray-700">
            ...
            <div class="mb-6">
              <div class="flex">
                <input 
                  ...
                  class="flex-1 rounded-l-md border-r-0 border-gray-300 focus:ring-orange-500 focus:border-orange-500"
                >
                <button 
                  class="px-4 py-2 bg-orange-500 text-white rounded-r-md hover:bg-orange-600"
                  @click="applyVoucher"
                >
                  Apply
                </button>
            ...
            <button 
              ...
              class="w-full py-3 bg-orange-500 text-white rounded-md hover:bg-orange-600 font-medium"
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-lg shadow-sm p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="form-control">
                  ...
                  <input 
                    ...
                    type="text" 
                    class="w-full rounded-md border-gray-300 focus:ring-orange-500 focus:border-orange-500" 
                    required
                  />
                </div>
            ...
            <div class="mb-6">
              ...
              <div v-if="selectedAddress" class="p-4 bg-gray-50 rounded-md mb-4">
                <div class="flex justify-between">
                  ...
                  <span v-if="selectedAddress.default" class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Default</span>
                </div>
              </div>
              ...
              <div class="flex gap-3">
                <button 
                  ...
                  class="px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 flex-1"
                >
                  Select Address
                </button>
                <button 
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4 mb-6">
              <div v-for="item in cartItems.filter(i => selectedItems[i.id])" :key="item.id" class="flex items-center">
                ...
                <div class="text-right">
                  <p class="text-sm font-semibold">${{ ((item.price * item.quantity) / 100).toFixed(2) }}</p>
                </div>
              </div>
            </div>
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3 mb-4 border-t border-gray-200 pt-4">
              ...
              <div v-for="item in cartItems.filter(i => selectedItems[i.id])" :key="item.id" class="flex justify-between text-sm">
                <span class="text-gray-600">{{ item.name }} (x{{ item.quantity }})</span>
                <span class="font-medium">${{ ((item.price * item.quantity) / 100).toFixed(2) }}</span>
              </div>
            </div>
      ...
      <div v-if="currentStep === 'confirmation'" class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <div class="space-y-3 mb-6">
            ...
            <div class="space-y-3 border-t border-gray-200 pt-4">
              <div v-for="item in cartItems.filter(i => selectedItems[i.id])" :key="item.id" class="flex justify-between">
            ...
            >
              <div class="flex items-start gap-3">
                <input 
                  type="radio" 
                  name="addressRadio" 
                  class="mt-1 h-4 w-4 text-orange-500 border-gray-300 focus:ring-orange-500" 
