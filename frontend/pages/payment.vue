    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="container max-w-3xl mx-auto px-4">
            ...
            <div v-else-if="paymentSuccess" class="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <p v-if="paymentMethod === 'qr'" class="text-gray-600 mb-2">ขอบคุณสำหรับการชำระเงิน
                    เราจะดำเนินการตามคำสั่งซื้อของคุณทันที</p>
                    ...
                    <div class="bg-orange-50 p-4 rounded-lg mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-orange-700">คุณจะต้องชำระเงินจำนวน {{
                                    formatPrice(orderDetails.total_amount) }} เมื่อได้รับสินค้า</p>
                                <p class="text-orange-700 mt-2">
                                    การชำระเงินสามารถทำได้โดยเงินสดหรือโอนเงินให้พนักงานส่งสินค้า</p>
                            </div>
                        </div>
                    </div>
