...
<template>
  <div class="sticky top-0 z-50">
              ...
              <details v-if="shouldShowDropdown(item)" class="dropdown dropdown-bottom desktop-dropdown">
                ...
                <ul class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52 mt-4">
                  <li v-for="catalog_item in catalog_placeholder" :key="catalog_item.slug">
                    <NuxtLink :to="`/products/${catalog_item.slug}`" @click="closeProductsDropdown">
                  ...
                  <li>
                    <NuxtLink to="/products" @click="closeProductsDropdown">
    ...
    <div v-if="showLogoutModal" class="fixed inset-0 flex items-center justify-center z-50">
      <div class="absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-200" @click="closeLogoutModal" />
